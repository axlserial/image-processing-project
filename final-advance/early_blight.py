...
def main():
    # Leemos las imágenes
    images = read_images(__file__, "early_blight")
    ...
    for image, file in images:
        ...
        labels = ski.segmentation.slic(
            img_adapteq, compactness=20, n_segments=200, start_label=1, sigma=3
        )
        rag = ski.color.label2rgb(labels, img_float, kind="avg", bg_label=0)
